...
describe LookupsController do
  ...
  describe "GET index" do
    it "assigns all lookups as @lookups" do
      ...
      assigns(:lookups).should eq([lookup])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested lookup as @lookup" do
      ...
      assigns(:lookup).should eq(lookup)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new lookup as @lookup" do
      ...
      assigns(:lookup).should be_a_new(Lookup)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created lookup as @lookup" do
        post :create, {:lookup => valid_attributes}, valid_session
        assigns(:lookup).should be_a(Lookup)
        assigns(:lookup).should be_persisted
      end

      it "redirects to the created lookup" do
        post :create, {:lookup => valid_attributes}, valid_session
        response.should redirect_to(Lookup.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved lookup as @lookup" do
        ...
        Lookup.any_instance.stub(:save).and_return(false)
        post :create, {:lookup => { "ac_type" => "invalid value" }}, valid_session
        assigns(:lookup).should be_a_new(Lookup)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested lookup" do
        lookup = Lookup.create! valid_attributes
        # Assuming there are no other lookups in the database, this
        # specifies that the Lookup created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Lookup.any_instance.should_receive(:update_attributes).with({ "ac_type" => "MyString" })
        put :update, {:id => lookup.to_param, :lookup => { "ac_type" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the lookup" do
        lookup = Lookup.create! valid_attributes
        put :update, {:id => lookup.to_param, :lookup => valid_attributes}, valid_session
        response.should redirect_to(lookup)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the lookup as @lookup" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Lookup.any_instance.stub(:save).and_return(false)
        put :update, {:id => lookup.to_param, :lookup => { "ac_type" => "invalid value" }}, valid_session
        assigns(:lookup).should eq(lookup)
      end
